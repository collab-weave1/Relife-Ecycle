...
export const MapRoute = ({ userLocation, recyclerLocation }) => {
    ...
    useEffect(() => {
      ...
      return () => map.remove();
    }, [userLocation, recyclerLocation]);
  
    return <div className="mt-6" style={{ height: '400px' }} ref={mapContainer}></div>;
};