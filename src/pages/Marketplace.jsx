...
const initialProducts = [
    { 
        ...
        condition: 'Excellent',
        warranty: '6 months',
        imageUrl: 'https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1738252498-samsung-galaxy-z-fold-6-006-679ba0c7c43be.jpg?crop=1xw:1xh;center,top&resize=980:*'
    },
    { 
        id: 2, 
        ...
        condition: 'Good',
        warranty: '3 months',
        imageUrl: 'https://www.pcworld.com/wp-content/uploads/2025/04/Framework-Laptop-13-Core-Ultra-1-open-3.jpg?resize=1536%2C1157&quality=50&strip=all'
    },
    { 
        id: 3, 
        ...
        condition: 'New',
        warranty: '1 year',
        imageUrl: 'https://www.parents.com/thmb/CjbD-yxpDiRfdG5Q3gTYCN2uvcE=/750x0/filters:no_upscale():max_bytes(150000):strip_icc()/prt-gabb-watch-3e-justyna-rivera-5-b59af4bc9ca04e4f9555c36f3e15c4cd.jpeg'
    }
];

export const Marketplace = ({ onLogout, onBack, currentUser }) => {
    ...
    return (
        <div className="ml-0 lg:ml-32 mt-16 pt-16 pb-8 px-4 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="bg-gradient-to-r from-green-200 to-blue-300 rounded-full p-3">
                            <span className="text-white text-2xl"><ShoppingCart className="w-5 h-5" /></span>
                        </div>
                        <div>
                            <h2 className="text-3xl font-bold text-gray-800">Marketplace</h2>
                            <p className="text-gray-600">Discover sustainable tech solutions</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    {products.map(product => (
                        <div key={product.id} className="group bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="bg-gray-100 px-2 py-1 rounded-full text-sm font-medium text-gray-800">
                                        {product.sellerType}
                                    </span>
                                </div>
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <div className="bg-purple-500 rounded-full p-2">
                                    <span className="text-white text-xl"><PlusCircle className="w-5 h-5" /></span>
                                </div>
                                <h3 className="text-2xl font-bold text-gray-800">Add New Product</h3>
                            </div>
                            <button
                                onClick={() => setShowAddForm(!showAddForm)}
                                className="bg-purple-500 text-white px-6 py-2 rounded-xl hover:from-purple-600 hover:to-pink-700 transition-all duration-300 font-medium"
                            >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    <label className="block text-sm font-semibold mb-2 text-gray-700">Warranty</label>
                                    <select
                                        name="warranty"
