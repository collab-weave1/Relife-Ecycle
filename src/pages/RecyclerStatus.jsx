...
export const RecyclerStatus = ({ onBack, onLogout }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50 ml-16">
            <div className="pt-20 pb-12 px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-4xl font-bold text-gray-900 mb-3">Collection Route</h1>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden mb-8">
                        <div className={`p-6 ${collectionStatus === 'collected' ? 'bg-gradient-to-r from-green-500 to-emerald-500' : 'bg-gradient-to-r from-blue-500 to-indigo-500'}`}>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-100 text-lg">
                                            {collectionStatus === 'collected' ? 'Successfully collected e-waste' : 'En route to pickup location'}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden mb-8">
                        ...
                        <div className="h-80 overflow-hidden">
                            <MapRoute
                                userLocation={dummyRecyclerLocation}
                                recyclerLocation={dummyUserLocation}
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 shadow-sm">
                                ...
                                <p className="text-2xl font-bold text-gray-800">15-20 min</p>
                                <p className="text-sm text-gray-600 mt-1">Current traffic conditions</p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-5 border border-green-100 shadow-sm">
                                ...
                                <p className="text-sm text-gray-600 mt-1">Estimated payout</p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-100 shadow-sm">
                                ...
                                <p className="text-2xl font-bold text-gray-800">3 devices</p>
                                <p className="text-sm text-gray-600 mt-1">Smartphone, Laptop, Tablet</p>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                                <h4 className="font-semibold text-blue-800 mb-3"><Smartphone className="w-5 h-5 mr-2" /> Smartphone</h4>
                                <p className="text-sm text-gray-600 mb-1">Brand: Apple iPhone 12</p>
                                <p className="text-sm text-gray-600 mb-1">Condition: Good</p>
                                <p className="text-lg font-bold text-blue-700">₹180</p>
                            </div>
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-100">
                                <h4 className="font-semibold text-green-800 mb-3"><Laptop className="w-5 h-5 mr-2" /> Laptop</h4>
                                <p className="text-sm text-gray-600 mb-1">Brand: Dell Inspiron</p>
                                <p className="text-sm text-gray-600 mb-1">Condition: Fair</p>
                                <p className="text-lg font-bold text-green-700">₹190</p>
                            </div>
                            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-100">
                                <h4 className="font-semibold text-purple-800 mb-3"><Smartphone className="w-5 h-5 mr-2" /> Tablet</h4>
                                <p className="text-sm text-gray-600 mb-1">Brand: Samsung Galaxy</p>
                                <p className="text-sm text-gray-600 mb-1">Condition: Good</p>
                                <p className="text-lg font-bold text-purple-700">₹50</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold text-gray-900">123 MG Road, Bangalore, Karnataka 560001</p>
                                    </div>
                                </div>
                                <div className="flex items-start p-4 bg-amber-50 rounded-lg border border-amber-200">
                                    ...
                                    <div>
                                        <p className="text-sm text-amber-700 font-medium">Special Instructions</p>
                                        <p className="text-sm text-amber-800">Ring bell twice, ask for Rajesh. Items are in the garage.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
