...
export const PickupStatus = ({ onLogout, onBack }) => {
            ...
            <div className="pt-20 pb-12 px-4">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-4xl font-bold text-gray-900 mb-3">Live Pickup Tracking</h1>
                        ...
                        <div className="p-6 bg-gradient-to-r from-gray-50 to-white">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 text-lg">{recyclerName}</h3>
                                        <p className="text-gray-600">Certified E-Waste Collector</p>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button className="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors flex items-center">
                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden mb-8">
                        ...
                        <div className="h-80 overflow-hidden">
                            <MapRoute
                                ...
                                recyclerLocation={dummyRecyclerLocation}
                            />
                        </div>
                    </div>

                    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-8">
                        <h3 className="text-xl font-semibold text-gray-900 mb-6">Pickup Progress</h3>
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-sm font-medium text-gray-700">Request Received</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-sm font-medium text-gray-700">Recycler Assigned</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-sm font-medium text-blue-600">En Route</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-sm font-medium text-gray-500">Pickup Complete</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200 p-6">
                        <div className="flex items-start">
                            ...
                            <div>
                                <h3 className="font-semibold text-amber-800 text-lg mb-3">Preparation Checklist</h3>
